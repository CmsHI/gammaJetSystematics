...
void drawSys_energyScale() {
  ...
  //  TFile * fSysResults = new TFile("relativeSys_dueTo_energyScaleMinus.root");
  TFile * fSysResults = new TFile("relativeSys_dueTo_energyScalePlus.root");
  ...
  for ( int coll = 1 ; coll<=4 ; coll++) {  
    for ( int ipt = 1 ; ipt <=nPtBin ; ipt++) {
      ...
      dNdJetPt[coll][ipt][2]->SetAxisRange(30,121,"X");
  ...
  //  c1->SaveAs("Uncertainty_of_dndjetpt_by_photonEnergyScaleMinus.pdf");
  //  c2->SaveAs("Uncertainty_of_meanjetpt_by_photonEnergyScaleMinus.pdf");
  //  c3->SaveAs("Uncertainty_of_r_by_photonEnergyScaleMinus.pdf");
  c1->SaveAs("Uncertainty_of_dndjetpt_by_photonEnergyScalePlus.pdf");
  c2->SaveAs("Uncertainty_of_meanjetpt_by_photonEnergyScalePlus.pdf");
  c3->SaveAs("Uncertainty_of_r_by_photonEnergyScalePlus.pdf");
